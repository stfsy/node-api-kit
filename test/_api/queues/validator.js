...
const createSchema = schemaCreator()
const updateSchema = createToUpdateSchemaConverter(schemaCreator())

export default nestedResourceValidator({ createSchema, updateSchema })