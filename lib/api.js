...
import { accessLog, bodyParser, contentType, cors, defaultVersion, normalizeRequest, securityHeaders, traceContext, upstreamCacheControl } from './middlewares/index.js';
...
app.use(normalizeRequest()) // update request properties to make sure they similar across requests
app.use(defaultVersion()) // use /v1 as default and strip /v1 from incoming paths
app.use(upstreamCacheControl()) // instruct CDNs and proxies to not cache the API responses
