...
/**
 * @typedef {import('hyper-express').Request } Request
 * @typedef {import('hyper-express').Response } Response
 * @typedef {import('hyper-express').Handler} RequestHandler
 * @typedef {import('hyper-express').Application} Application 
 * @typedef {import('hyper-express').NextFunction} NextFunction 
 * @typedef {import('hyper-express').RequestHandler} RequestHandler 
