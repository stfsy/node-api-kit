...
import { createTracer, getTraceIdFromLocalStorage, logError, logInfo, logWarn } from '../util/index.js';

const { withOrpanedSpan } = createTracer('access-log-middleware', {
