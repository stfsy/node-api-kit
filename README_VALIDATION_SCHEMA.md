# Usage
This document describes how to define validation schemas. Validation schemas are used to validate incoming http requests and, therefore, essential part of API security.
